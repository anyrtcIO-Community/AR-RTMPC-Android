...
public class ARProximitySensor implements SensorEventListener {
	...
	public void stop() {
		checkIfCalledOnValidThread();
		Log.d(TAG, "stop" + ARUtils.getThreadInfo());
	...
	public final void onAccuracyChanged(Sensor sensor, int accuracy) {
		checkIfCalledOnValidThread();
		ARUtils.assertIsTrue(sensor.getType() == Sensor.TYPE_PROXIMITY);
	...
	public final void onSensorChanged(SensorEvent event) {
		checkIfCalledOnValidThread();
		ARUtils.assertIsTrue(event.sensor.getType() == Sensor.TYPE_PROXIMITY);
		...
		Log.d(TAG, "onSensorChanged" + ARUtils.getThreadInfo() + ": " + "accuracy=" + event.accuracy + ", timestamp="
