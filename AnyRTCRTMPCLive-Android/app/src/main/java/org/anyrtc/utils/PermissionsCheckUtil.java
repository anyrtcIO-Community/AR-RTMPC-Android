...
//                e.printStackTrace();
    ...
    public static void showMissingPermissionDialog(final Activity activity, String message) {
        ...
        build.setTitle(activity.getString(R.string.str_connect_hoster));
        build.setMessage(message);
        if (canSetting) {
            build.setPositiveButton(activity.getString(R.string.str_setting), new DialogInterface.OnClickListener() {
        ...
        build.setNegativeButton(activity.getString(R.string.str_cancel), new DialogInterface.OnClickListener() {
