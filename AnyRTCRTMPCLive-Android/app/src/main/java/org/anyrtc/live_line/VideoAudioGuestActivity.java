 ...
 * 视频游客页面
 */
public class VideoAudioGuestActivity extends AppCompatActivity implements ScrollRecycerView.ScrollPosation {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_audio_guest);
    ...
    public void OnBtnClicked(View btn) {
        if(btn.getId() == R.id.btn_copy_hls) {
            ...
            if (mCheckBarrage.isChecked()) {
                ...
                IDanmakuItem item = new DanmakuItem(VideoAudioGuestActivity.this, new SpannableString(message), mDanmakuView.getWidth(), 0, R.color.yellow_normol, 18, 1);
            ...
            softKeyboardUtil.showKeyboard(VideoAudioGuestActivity.this, editMessage);
        }
    }
    ...
    private void setEditTouchListener() {
        ...
        softKeyboardUtil.observeSoftKeyboard(VideoAudioGuestActivity.this, new SoftKeyboardUtil.OnSoftKeyboardChangeListener() {
            @Override
...
//            });
            ...
            VideoAudioGuestActivity.this.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (code == 0) {
                        ...
                        Toast.makeText(VideoAudioGuestActivity.this, R.string.str_hoster_not_live, Toast.LENGTH_LONG).show();
            ...
            VideoAudioGuestActivity.this.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (code == 0) {
                        ...
                        Toast.makeText(VideoAudioGuestActivity.this, R.string.str_hoster_refused, Toast.LENGTH_LONG).show();
                        mStartLine = false;
                        mBtnConnect.setText(R.string.str_connect_hoster);
                    }
                }
        ...
        public void OnRTCLineLeaveCallback(int code, String strReason) {
            ...
            VideoAudioGuestActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(VideoAudioGuestActivity.this, R.string.str_hoster_leave, Toast.LENGTH_LONG).show();
                    mHandler.sendEmptyMessageDelayed(CLOSED, 2000);
                }
            });
        }
        ...
        public void OnRTCUserBarrageCallback(final String strCustomID, final String strCustomName, final String strCustomHeader, final String strBarrage) {
            VideoAudioGuestActivity.this.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    IDanmakuItem item = new DanmakuItem(VideoAudioGuestActivity.this, new SpannableString(strBarrage), mDanmakuView.getWidth(), 0, R.color.yellow_normol, 18, 1);
                    mDanmakuView.addItemToHead(item);
                }
            });
        }
